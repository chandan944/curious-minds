...
export default {
  ...
  quiz: [
    { id: 'q1', question: "What is the primary evolutionary purpose of Anger?", options: ["To build social bonds", "To fuel survival fight responses", "To improve logical thinking", "To burn excess body fat"], answer: 1, explanation: "Anger is the 'Fight' in 'Fight or Flight', providing explosive energy to defend boundaries. 🛡️" },
    ...
    { id: 'q3', question: "An 'Amygdala Hijack' occurs when the emotional brain bypasses which logical section of the brain?", options: ["The Cerebellum", "The Occipital Lobe", "The Prefrontal Cortex", "The Brain Stem"], answer: 2, explanation: "It bypasses the Prefrontal Cortex, cutting off your access to logic and consequence-prediction! 🧠" },
    ...
    { id: 'q6', question: "Chronic, unresolved anger and hostility are strong predictors for which physical illness?", options: ["Chronic asthma", "Heart disease and attacks", "Severe scoliosis", "Sudden blindness"], answer: 1, explanation: "Hostility puts massive constant pressure on blood vessels, leading directly to cardiovascular disease. 💔" },
    { id: 'q7', question: "What is 'Trigger Stacking'?", options: ["Organizing weapons", "Accumulating small stressors until explosion", "Using healthy coping mechanisms", "Forgetting the original anger source"], answer: 1, explanation: "Dropping the keys didn't cause the rage; the 5 stressors before it did! 🥞" },
    { id: 'q8', question: "How long does it take for the initial chemical rush of an angry trigger to begin fading?", options: ["One second", "Six seconds", "Ten minutes", "Two hours"], answer: 1, explanation: "The '6-Second Rule' exploits the fact that the initial adrenaline spike peaks and begins clearing quickly! ⏱️" },
    ...
    { id: 'q10', question: "According to modern psychology, violently 'venting' anger (like punching walls or pillows) usually:", options: ["Cures anger completely", "Induces immediate sleepiness", "Reinforces aggression and prolongs anger", "Reduces blood pressure levels"], answer: 2, explanation: "The Catharsis myth is busted; acting violently just tells your brain 'Yes, it is time to fight!' 🥊" },
    { id: 'q11', question: "Why do we pace around when we are furiously angry?", options: ["Searching for weapons", "Releasing adrenaline for physical action", "Creating wind to cool down", "Stretching tight muscles"], answer: 1, explanation: "Your body is hyper-charged with fuel that has nowhere to go if you aren't physically fighting! 🏃‍♂️" },
    { id: 'q12', question: "'Righteous Anger' is best described as:", options: ["Anger directed inward", "Anger used to fight injustice", "Anger at religious figures", "Anger over minor issues"], answer: 1, explanation: "Righteous anger is the moral fuel of change and reform! ⚖️" },
    { id: 'q13', question: "What is the biological reason behind being 'Hangry'?", options: ["Low hydration levels", "Low blood sugar releasing cortisol", "Stomach pressure on the brain", "Missing specific food flavors"], answer: 1, explanation: "Low glucose = survival threat = panic and rage! 🍔" },
    { id: 'q14', question: "By breathing deeply and slowly when angry, which nerve do you activate to force the heart rate down?", options: ["The Sciatic Nerve", "The Optic Nerve", "The Vagus Nerve", "The Spinal Cord"], answer: 2, explanation: "Deep breathing stimulates the Vagus Nerve, directly pulling the brakes on the sympathetic nervous system! 🫁" },
    { id: 'q15', question: "During an attack of rage, which bodily function is typically restricted/reduced?", options: ["Resting heart rate", "Peripheral vision and focus", "Adrenaline production levels", "Total lung capacity"], answer: 1, explanation: "Blood flows away from unessential sight towards the center of focus, literally creating tunnel vision! 🙈" },
    { id: 'q16', question: "If anger is a 'Secondary Emotion', what is an example of the 'Primary Emotion' hiding beneath it?", options: ["Feeling joy", "Feeling hunger", "Feeling abandoned or disrespected", "Feeling excitement"], answer: 2, explanation: "We feel disrespected (pain), and the ego quickly covers the pain with rage (power). 🛡️" },
    { id: 'q17', question: "What physical change occurs in your blood vessels when experiencing chronic anger?", options: ["Vessels turn blue", "Vessels dissolve away", "Vessels constrict raising blood pressure", "Vessels expand lowering pressure"], answer: 2, explanation: "Constriction forces the heart to work overtime, damaging the arterial walls over time. ⚡" },
    { id: 'q18', question: "When the Amygdala hijacks the brain, what happens to your ability to articulate complex words?", options: ["Verbal skills improve", "Verbal skills remain stable", "Verbal skills plummet significantly", "Verbal skills change languages"], answer: 2, explanation: "Your complex vocabulary lives in the Prefrontal cortex, which is turned off during an Amygdala Hijack! 🤬" },
    { id: 'q19', question: "Which scenario best describes 'Positive Intent Assumption' as an anger management technique?", options: ["Assuming intentional harm", "Assuming accidental contact", "Ignoring everyone completely", "Believing you are right"], answer: 1, explanation: "Assuming positive intent removes the perceived 'threat', instantly neutralizing the anger response! 🕊️" },
    { id: 'q20', question: "The emotion of anger is universally recognized across all human cultures through:", options: ["Spoken word choices", "Specific facial micro-expressions", "Physical walking styles", "Cultural clothing styles"], answer: 1, explanation: "Facial expressions for anger are genetically hardwired into humans, not culturally learned! 😠" },
  ],
