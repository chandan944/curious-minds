...
export default {
  ...
  quiz: [
    { id: 'q1', question: "What is the core premise of 'Attachment Theory'?", options: ["Digital file organization", "Early bonds shape adult relationships", "Physical muscle and bone connections", "Random chance in romantic love"], answer: 1, explanation: "If your caregivers were inconsistent, your brain wired itself to view love as dangerous or unstable! 🧩" },
    { id: 'q2', question: "A person who is hyper-vigilant, fears abandonment, and needs constant reassurance likely has which attachment style?", options: ["Secure attachment style", "Anxious attachment style", "Avoidant attachment style", "Disorganized attachment style"], answer: 1, explanation: "Anxious attachers pursue closeness aggressively because distance feels like a literal survival threat! 🌪️" },
    { id: 'q3', question: "If someone values extreme independence, views intense intimacy as a trap, and physically pulls away when things get 'too close', they likely have which attachment style?", options: ["Anxious attachment style", "Avoidant attachment style", "Secure attachment style", "Clingy attachment style"], answer: 1, explanation: "Avoidants learned early on that they could only rely on themselves, so intimacy feels like a loss of freedom. 🧊" },
    { id: 'q4', question: "Which statement best describes the 'Anxious-Avoidant Trap'?", options: ["They never meet socially", "Cycle of pursuit and withdrawal", "Instant and permanent love", "Mutual silence and ignoring"], answer: 1, explanation: "It is a painful dance where one chases entirely out of fear, and the other runs entirely out of fear! 💃🕺" },
    { id: 'q5', question: "What is an 'Emotional Bid' according to Dr. John Gottman?", options: ["Financial offer at auction", "Small attempt to connect", "Request for a gift", "Threat to end relationship"], answer: 1, explanation: "Bids are the tiny building blocks of trust. They are constantly happening all day long! 💬" },
    { id: 'q6', question: "If your partner says 'Look at that dog!' and you ignore them and keep looking at your phone, you are:", options: ["Turning toward the partner", "Turning away from partner", "Turning against the partner", "Being efficient with time"], answer: 1, explanation: "Turning Away signals to the partner's brain that they are not worthy of your attention, eroding trust over time. 📉" },
    { id: 'q7', question: "Dr. Gottman found that successful couples 'Turn Toward' emotional bids what percentage of the time?", options: ["33 percent of time", "50 percent of time", "86 percent of time", "100 percent of time"], answer: 2, explanation: "Masters of relationships engage with their partner's attempts at connection 86% of the time! 📈" },
    { id: 'q8', question: "Which of 'The Four Horsemen' involves attacking your partner's character using words like 'always' or 'never'?", options: ["The Horseman of Contempt", "The Horseman of Criticism", "The Horseman of Stonewalling", "The Horseman of Defensiveness"], answer: 1, explanation: "Criticism attacks the PERSON. A complaint attacks the BEHAVIOR. Big difference! 🗣️" },
    { id: 'q9', question: "Which is the deadliest Horseman, predicting divorce with the highest accuracy?", options: ["The Horseman of Criticism", "The Horseman of Defensiveness", "The Horseman of Contempt", "The Horseman of Stonewalling"], answer: 2, explanation: "Contempt is sulfuric acid to love. It tells the partner: 'I am better than you, and you are disgusting.' ☠️" },
    { id: 'q10', question: "What is 'Defensiveness' in the context of an argument?", options: ["Holding a physical shield", "Playing victim to avoid blame", "Offering a sincere apology", "Leaving the room immediately"], answer: 1, explanation: "Defensiveness says: 'The problem isn't me, it's YOU!' The antidote is to take ownership of even 1% of the issue. 🧱" },
    { id: 'q11', question: "When a partner totally withdraws, shuts down, and gives the 'silent treatment' during an argument, this is called:", options: ["Winning the argument", "Stonewalling the partner", "Showing deep contempt", "Secure attachment behavior"], answer: 1, explanation: "Stonewalling usually happens because the person is biologically 'Flooded' with stress hormones and cannot process data. 🗿" },
    { id: 'q12', question: "What should you immediately do if an argument causes your heart rate to spike over 100 BPM (Flooding)?", options: ["Yell louder at partner", "Take a 20-minute timeout", "Cry to release emotion", "Throw objects in anger"], answer: 1, explanation: "Logic is biologically impossible when flooded. Take a break, do not ruminate, and come back calm! 🛑" },
    { id: 'q13', question: "Secure attachers make up roughly what percentage of the population?", options: ["10 percent of people", "50 percent of people", "90 percent of people", "0 percent of people"], answer: 1, explanation: "They don't often show up in dating pools for long, because they find healthy partners and stay with them. ⚓" },
    { id: 'q14', question: "Why do Anxious individuals often misinterpret 'quiet time' from their partner?", options: ["They enjoy the silence", "Silence signals potential abandonment", "They cannot hear well", "They assume partner sleeps"], answer: 1, explanation: "Anxious brains require high amounts of verbal reassurance that 'everything is okay.' 🌪️" },
    { id: 'q15', question: "What is an excellent 'Antidote' to Criticism?", options: ["Criticize the partner back", "Use 'I' statements for feelings", "Ignore the partner completely", "Scream to be heard"], answer: 1, explanation: "An 'I' statement bypasses the partner's Ego, preventing them from automatically becoming defensive! 🛡️" },
    { id: 'q16', question: "A fundamental belief of an Avoidant attacher is:", options: ["Total fusion with partner", "Self-reliance is the only safety", "Everyone is inherently trustworthy", "Being alone is painful"], answer: 1, explanation: "They view independence as ultimate survival, causing them to flinch when intimacy feels 'heavy.' 🧊" },
    { id: 'q17', question: "The tragedy of the Anxious attachment style is that their desperate pursuit of closeness often:", options: ["Increases personal wealth", "Smothers partner causing abandonment", "Creates immediate deep love", "Cures all personal anxiety"], answer: 1, explanation: "By holding on too tightly, they accidentally crush the relationship they are trying to save! 🏃‍♂️💨" },
    { id: 'q18', question: "What happens to the immune system of someone who is constantly subjected to Contempt by their partner?", options: ["Becomes significantly stronger", "Weakens due to high stress", "Remains completely unchanged", "Heals existing allergies"], answer: 1, explanation: "Toxic communication isn't just emotionally painful; it is physically destructive to human biology. 🦠" },
    { id: 'q19', question: "Which action is an example of 'Turning Against' an emotional bid?", options: ["Smiling at the partner", "Looking at a phone", "Snapping with an angry response", "Buying flowers for them"], answer: 2, explanation: "Turning Against isn't just ignoring them; it's actively creating hostility in response to a bid for connection. ⚔️" },
    { id: 'q20', question: "According to Gottman's 'Magic Ratio', how many positive interactions are needed to balance out one negative interaction?", options: ["1 to 1 ratio", "2 to 1 ratio", "5 to 1 ratio", "10 to 1 ratio"], answer: 2, explanation: "Because of our negativity bias, a 1:1 ratio isn't enough. You need FIVE positive moments to repair the damage of one negative moment. ⚖️" },
  ],
