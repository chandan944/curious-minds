...
export const createTheme = (isDark = true) => ({
  ...
  topics: {
    ...
    greed:       { primary: '#D4AF37', shadow: 'rgba(212,175,55,0.30)' },
    ...
    stars:       { primary: '#FFFACD', shadow: 'rgba(255,250,205,0.30)' },
    ...
    enlightenment: { primary: '#F6E05E', shadow: 'rgba(246,224,94,0.30)' },
