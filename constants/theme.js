...
export const createTheme = (isDark = true) => ({
  ...
  topics: {
    ...
    personal_finance: { primary: '#FBBF24', shadow: 'rgba(251,191,36,0.30)' },
    banking:     { primary: '#3B82F6', shadow: 'rgba(59,130,246,0.30)' },
    investing:   { primary: '#10B981', shadow: 'rgba(16,185,129,0.30)' },
    debt_credit: { primary: '#F43F5E', shadow: 'rgba(244,63,94,0.30)' },
    taxation:    { primary: '#14B8A6', shadow: 'rgba(20,184,166,0.30)' },
    real_estate: { primary: '#D97706', shadow: 'rgba(217,119,6,0.30)' },
    corporate:   { primary: '#6366F1', shadow: 'rgba(99,102,241,0.30)' },
    insurance:   { primary: '#0EA5E9', shadow: 'rgba(14,165,233,0.30)' },
    wealth:      { primary: '#FFD700', shadow: 'rgba(255,215,0,0.30)' },
